        ...
        <div class="card-body">
            ...
            @foreach ($cities as $city)
                ...
                <tr class="odd">
                  ...
                  <td>  
                    <a href={{url(route('cities.edit',$city->id))}} class="btn btn-primary">edit num {{$city->id}}</a>
                  </td>
                  <td>  
                    <form method='post' action='{{url(route('cities.destroy',$city->id))}}'>
                      @csrf
                      <input type="hidden" name='_method' value='delete' />
                    <button type='submit' class="btn btn-primary">delete num {{$city->id}}</button>
                    </form> 
                  </td>
                </tr>
